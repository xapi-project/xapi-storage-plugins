...
BLOCK_COMMANDS=Plugin.Query Datapath.activate  Datapath.attach  Datapath.deactivate  Datapath.detach
...
install:
	...
	(cd src/tapdisk; install -m 0755 $(BLOCK_COMMANDS) $(DESTDIR)$(SCRIPTDIR)/datapath/raw+block)
